  ...
  <div class="modal-dialog">
    <form method="POST" id="formUser" class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalUpdateLabel"><i class="bi bi-plus-circle"></i> Edit User</h5>
...
document.querySelectorAll('.btn-edit').forEach(button => {
  button.addEventListener('click', function() {
    ...
    document.getElementById('modalUpdateLabel').innerHTML = '<i class="bi bi-pencil-square"></i> Edit User';
