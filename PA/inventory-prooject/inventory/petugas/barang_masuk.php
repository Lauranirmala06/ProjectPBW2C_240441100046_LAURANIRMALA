...
if (isset($_POST['tambah'])) {
    ...
    if ($id_barang && $jumlah > 0 && $tanggal) {
        ...
        if ($stmt->execute()) {
            ...
            $_SESSION['message'] = "Gagal menambah barang masuk!";
...
if (isset($_POST['edit'])) {
    ...
    if ($id && $id_barang && $jumlah_baru > 0 && $tanggal) {
        ...
        if ($stmt->execute()) {
            ...
            $_SESSION['message'] = "Gagal mengubah barang masuk!";
            $_SESSION['message_type'] = "danger";
        }
    } else {
        $_SESSION['message'] = "Data tidak valid!";
...
$sql = "SELECT bm.id, i.nama_barang, bm.jumlah, bm.tanggal, u.username, bm.id_barang
...
<div class="container py-4">
    <div class="page-header d-flex align-items-center justify-content-between flex-wrap mb-4">
      <div class="d-flex align-items-center gap-2">
        ...
        <h3 class="mb-0">Barang Masuk</i></h3>
      </div>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="6" class="text-center text-secondary">Belum ada data barang masuk.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
  ...
  <div class="modal-dialog">
    <form method="post" class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalTambahLabel"><i class="bi bi-plus-circle"></i> Tambah Barang Masuk</h5>
...
<div class="modal fade" id="modalEdit" tabindex="-1" aria-labelledby="modalEditLabel" aria-hidden="true">
  <div class="modal-dialog">
    <form method="post" class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="modalEditLabel"><i class="bi bi-pencil-square"></i> Edit Barang Masuk</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
      </div>
      <div class="modal-body">
        <div class="mb-3">
...
<div class="modal fade" id="modalHapus" tabindex="-1" aria-labelledby="modalHapusLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Yakin ingin menghapus data <b id="hapus_nama"></b>?
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
        <a href="barang_masuk.php" id="hapusLink" class="btn btn-danger">Ya, Hapus</a>
      </div>
    </div>
  </div>
</div>
